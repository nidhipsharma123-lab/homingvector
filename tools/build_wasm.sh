...
FILES="core/task/task.cpp core/task/score.cpp core/task/cbba.cpp core/hal/capability_profile.cpp core/hal/kinematic_envelope.cpp core/health/degradation.cpp core/health/failure_response.cpp core/health/quorum_policy.cpp core/nav/spoof_detector.cpp core/world/belief.cpp core/common/time.cpp core/common/log.cpp core/world/track_fusion.cpp core/task/formation.cpp core/task/separation.cpp core/task/shared_assign.cpp core/common/geodesy.cpp"
